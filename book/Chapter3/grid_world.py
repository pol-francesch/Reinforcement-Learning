...
def draw_policy(optimal_values):
    ...
    ax.add_table(tb)
# End draw_policy function definition

def figure_3_2():
    value = np.zeros((WORLD_SIZE, WORLD_SIZE))
    while True:
        # Keep iterating until the solution converges
        ...
        if np.sum(np.abs(value - new_value)) < 1e-4:
            ...
            break
        value = new_value
# End figure_3_2 function definition

def figure_3_2_linear_system():
    # Solve linear system of equations to find exact solution.
    # Done by filling coefficients for each of the states with the respective right side constant
